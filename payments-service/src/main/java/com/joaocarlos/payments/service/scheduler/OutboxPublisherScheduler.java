package com.joaocarlos.payments.service.scheduler;
...
public class OutboxPublisherScheduler {
    ...
    public OutboxPublisherScheduler(
            ...
            @Value("${payments.outbox.publisher.batch-size:50}") int batchSize,
            @Value("${payments.outbox.publisher.max-retries:3}") int maxRetries) {
    ...
    @Scheduled(fixedDelayString = "${payments.outbox.publisher.fixed-delay-ms:5000}")
    @Transactional
