package com.joaocarlos.products.service.scheduler;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.joaocarlos.products.dao.jpa.entity.OutboxEntity;
import com.joaocarlos.products.dao.jpa.entity.OutboxStatus;
import com.joaocarlos.products.dao.jpa.repository.OutboxRepository;
...
public class OutboxPublisherScheduler {
    ...
    public OutboxPublisherScheduler(
            ...
            @Value("${products.outbox.publisher.batch-size:50}") int batchSize,
            @Value("${products.outbox.publisher.max-retries:3}") int maxRetries) {
    ...
    @Scheduled(fixedDelayString = "${products.outbox.publisher.fixed-delay-ms:5000}")
    @Transactional
